...
(function() {
  var MAX_ROOM_SIZE, VALID_UPDATE_STATUSES, app, express, generateId, getFullSummary, getPeerCount, io, logfmt, normalizeURL, onPeerConnected, onPeerDisconnected, pageIdToPeerAndUrlId, port, server, urlIdToPeerIds, urlIdToURL, urlToURLIds, uuid,
    _this = this;
